...
class CaDISNet(nn.Module):
    def __init__(self, nb_classes, Chans=64, Samples=128, 
        ...
        with torch.no_grad():
            ...
            # print(f"[DEBUG] CaDISNet: Input Samples={Samples}, Detected Time_Steps={self.final_time_steps}")
...
# Backward-compatible alias for older scripts that still import CausalEEGNet.
CausalEEGNet = CaDISNet
